...
if($property_title=='' or $description=='' or $property_keyword=='' or $properties_categories=='' or $properties_popular=='' or $property_image1=='' or $property_image2=='' or $property_image3=='' or $property_price==''){
    ...
    //insert query
    $insert_properties="insert into `properties`(property_title,property_description,property_keywords,category_id,popular_id,property_image1,property_image2,property_image3,property_price,date,status) values('$property_title','$description','$property_keyword','$properties_categories','$properties_popular','$property_image1','$property_image2','$property_image3','$property_price',NOW(),'$property_status')";
    $result_query=mysqli_query($con,$insert_properties);
    if($result_query){
        echo "<script>alert('property details has been inserted successfully')</script>";
    }
    }
}
?>
